...
Awacorn::AsyncFn<Promise::Promise<void>>
main_ui(Screen *screen, const std::vector<std::string> &args) {
    ...
    return Generator::AsyncGenerator<void>(
               [ev, screen,
                args](Generator::AsyncGenerator<void>::Context *ctx) {
                 ...
                 ev->create(
                     [&window, &ui, &window_index,
                      &flag](Awacorn::EventLoop *,
